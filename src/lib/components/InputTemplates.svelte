...
<style>
  ...
  .template-modal header .icon-button {
    margin: 0;
  }
  .template-heading {
    display: flex;
  ...
  .template-body {
    ...
    flex: 1;
    /* The shared focus ring extends beyond controls; keep it inside the scrollport. */
  ...
  .template-use:not(:disabled):hover {
    background: var(--hover);
  }
