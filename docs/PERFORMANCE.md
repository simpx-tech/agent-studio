...
The app freezes whenever one of two threads stays busy: the page's main thread, which runs the Svelte app and Chromium's style and layout, or the native UI thread, which runs synchronous Tauri commands and also handles the window's input. Four freezes found on 2026-09-24 and 2026-09-26 show the patterns to avoid (details in [VERIFICATION.md](VERIFICATION.md)):
