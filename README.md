...
- Share one VPS with separate users through private workspace keys. Each workspace has its own chats, computers, environments, and notifications. See [private workspace setup](docs/PRIVATE-WORKSPACES.md).
